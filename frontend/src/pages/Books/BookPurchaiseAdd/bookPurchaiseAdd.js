                        ...
                        <div className="divPuchaiseFormContainor">
                            <Form>
                                ...
                                <div className="buttonDiv">
                                    <Button variant="success" onClick={addButton}>Add Purchaise</Button>{' '}
                                    <Button variant="success" onClick={viewButton}>View Purchaises</Button>{' '}
                                </div>
                            </Form>
