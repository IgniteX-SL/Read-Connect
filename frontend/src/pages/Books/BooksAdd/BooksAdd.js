              ...
              <Form>
                <Row className="mb-3">
                  ...
                  <Col>
                    ...
                    <Form.Control
                      id="memberIDInput"
                      onChange={(e) => setGenresAndCategories(e.target.value)}
                      value={genresAndCategories}
                    />
                  </Col>
                </Row>
                <Row className="mb-3">
                  ...
                  <Col>
                    ...
                    <Form.Control
                      id="memberIDInput"
                      onChange={(e) => setTagsAndKeywords(e.target.value)}
                      value={tagsAndKeywords}
                    />
                  </Col>
                </Row>
                <Row className="mb-3">
                ...
                <Row className="mb-3">
                  ...
                  <Col>
                    ...
                    <Form.Control
                      id="memberIDInput"
                      onChange={(e) =>
                        setAdditionalContributors(e.target.value)
                      }
                      value={additionalContributors}
                    />
                  </Col>
                </Row>
                ...
                <Row className="mb-3">
                  <Col>
                    ...
                    <Form.Control
                      id="memberIDInput"
                      onChange={(e) => setGovernmentGrantsID(e.target.value)}
                      value={governmentGrantsID}
                    />
                  </Col>
                  <Col>
                ...
                <Row className="mb-3">
                  <Col>
                    ...
                    <Form.Control
                      id="memberIDInput"
                      onChange={(e) => setcupboardNo(e.target.value)}
                      value={cupboardNo}
                    />
                  </Col>
                  <Col>
